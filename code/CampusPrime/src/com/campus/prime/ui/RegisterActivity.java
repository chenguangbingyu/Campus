...
public class RegisterActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mUsernameView = (EditText)findViewById(R.id.re_username);
		mUsernameView.setText(mUsername);

		
		mEmail = getIntent().getStringExtra(EXTRA_EMAIL);
		mEmailView = (EditText) findViewById(R.id.re_email);
		mEmailView.setText(mEmail);

		mPasswordView = (EditText) findViewById(R.id.re_password);
		mPasswordView
	...
	public class UserLoginTask extends AsyncTask<Void, Void, UserProfile> {
		...
		protected UserProfile doInBackground(Void... params) {
			...
			UserProfile user= service.register(mUsername, mEmail, mPassword);
		...
		@Override
		protected void onPostExecute(final UserProfile user) {
			mAuthTask = null;
			showProgress(false);
